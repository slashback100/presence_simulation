...
⚠️ From v4, the parameter `switch_id` is mandatory *if you have several switches*. It should be the name of the switch you wan't to turn on.
...
⚠️ From v4, the parameter `switch_id` is mandatory *if you have several switches*. It should be the name of the switch you wan't to turn off.
...
⚠️ From v4, the parameter `switch_id` is mandatory *if you have several switches*. It should be the name of the switch you wan't to toggle.
