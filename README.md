...
:warning: you may encounter an "User input malformed" error. Change the Delta to something else than 7, save, then you can change back to 7 clicking in the option of the integration. This is a known issue.
